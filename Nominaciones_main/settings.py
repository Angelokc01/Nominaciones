"""
Django settings for Nominaciones_main project.
...
ROOT_URLCONF = 'Nominaciones_main.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'Nominaciones_main', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Nominaciones_main.wsgi.application'
...
DATABASES = {
     'default': {
         ...
         'NAME': 'nominaciones_main_db',
         'USER': 'nominaciones_main_user',
         'PASSWORD': 'isis2503',
         'HOST': '10.128.0.2',
         'PORT': '',
     }
...
AUTHENTICATION_BACKENDS = {
    'Nominaciones_main.auth0backend.Auth0',
